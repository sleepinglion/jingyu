...
이 318명은 그냥 식솔이 아니라 실제로 전투에 투입할 수 있는 병력으로 묘사됩니다.

즉, 정예 사병만 318명이라는 뜻은 그 뒤에 있는 가족, 종, 목자, 노동 인력, 가축 관리 인원까지 포함하면
아브라함의 세력은 수천 명 이상이었을 가능성이 높습니다.

당시 기준으로 보면 이는 단순한 개인이 아니라, 사실상 하나의 부족 집단을 이끄는 대부족장 혹은 소왕에 가까운 규모입니다.

실제로 성경에서도 아브라함은 소돔 왕과 전리품 문제를 놓고 거의 대등한 위치에서 대화합니다.
이 장면만 봐도 아브라함은 우리가 흔히 생각하는 \'가족 대표\' 수준이 아니라, 독자적인 세력을 가진 유력자였다고 보는 편이 자연스럽습니다.

그런데 영화나 드라마에서는 아브라함을 가족 몇 명만 데리고 다니는 노인처럼 묘사하는 경우가 많습니다.
그래서 아브라함의 실제 위상과 규모를 과소평가하게 만드는 경우가 꽤 있습니다.

<h2>2. 모세는 출애굽 당시 80세였다</h2>

성경에 따르면 모세는 이집트에서 이스라엘 백성을 이끌고 나올 때 80세였습니다.

많은 사람들이 영화나 드라마 속 이미지 때문에 모세를 중년의 지도자 정도로 떠올리지만,
성경 본문 기준으로는 이미 상당한 고령이었습니다.

오히려 예전에는 모세를 나이 들어 보이는 배우가 연기하는 경우가 많았는데,
요즘 재현물이나 영상에서는 점점 젊은 이미지로 나오는 경우가 많아서
성경을 잘 모르는 사람들에게는 잘못된 인상을 줄 수 있습니다.

물론 영상은 연출의 편의를 따르기도 하지만,
적어도 성경 본문 자체만 놓고 보면 출애굽 당시의 모세는 분명히 80세 인물입니다.
