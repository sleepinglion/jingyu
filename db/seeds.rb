...
공산주의는 자본주의의 악랄한 문제점들은 순식간에 해결했다.
  ...
  니가 군대에 입대했을때 이전의 "내무실 총기난사"로 덕 보는것 처럼
우리가 자본주의 살고 있지만 "공산주의", "공산혁명" 의 덕을 보고 있다.

  공산주의가 없었다면 지금의 자본주의가 아니였기 때문이다.
                              (애초 케인즈주의 도입했을때부터 순수 자본주의 거리가 멀다)

아 그리고 우리나라의 좋은 건강보험도
북한에서 하는 무상의료에 대항하기 위해 만들어졌다
역시 북한이 없었으면 건강보험도 없거나 약했을 가능성이 크다 / 그 외에도 북한이 있었기에 이승만 정권의 토지개혁도 잘 되었고 부의 분배가 되었다')
