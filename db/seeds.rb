...
Blog.create!(id: 31, user_id: 1, blog_category_id: 3,title: '멸공?? 뭐가 있어야지 없애든지 하지?? 에휴....' ,description: '윤어게인들의 멸공,이제는 있지도 않은것을 어떻게 없애자는건지', created_at: 1.day.ago,tag_list: '멸공,공산주의,윤어게인,정신병,맹수,비정상,헛소리,음모론',
             content: '요즘 “멸공” 이야기 보면
무서운 공산주의 반대하고 없애자는데 뭐가 문제냐? 하는데
이는 마치 뜬금 “맹수를 죽이자!!” 외치며
수 많은 사람 죽인 무서운 맹수를 죽이자는데 뭐가 문제냐??
하는것과 같다
맹수가 어디 있어?? ㅋㅋㅋㅋ 동물원에 있는애들 죽여??
공산주의도 마찬가지 인데? ㅎㅎㅎㅎ
물론 당시에는 맹수가 사람죽이고 공산주의도 그랬던적은 있고 무섭고 나쁜것은 맞다
하지만 시간이 지나 지금에서 그러는것은 비정상, 시대착오인것이다. 그마나 이제는 거의 안 계시겠지만 직접경험하신분들이 그러면 일종의 외상후장애겠거니 하며 슬플텐데 그것도 아닌애들은 스스로 비정상 인증
')



Blog.create!(id: 32, user_id: 1, blog_category_id: 3,title: '병영부조리를 한번에 해결하는 총기난사, 자본주의의 악랄함을 한번에 해결한 "공산주의, 공산혁명"' ,description: '가만히 있으면 가마니로 보지요?, 한 번씩 터트려야 위도 아래를 무서운지 알고 알아서 잘 함, 프랑스는 아직도 부유층에서 부 과시 하는것에 조심스러워 한다고 합니다.', created_at: 1.day.ago,tag_list: '총기난사,내무실, 북한, 공산혁명,건강보험,멸공,공산주의',
  content: '"공산주의, 공산혁명"은 "내무실 총기난사" 같은 것이다.
  사람 죽고 안 좋은 점에서 공통이다.

    또한 내무실 총기난사 발생할 수록  병영부조리를 순식간에 해결한 것처럼
공산주의는 자본주의의 악랄한 문제점들은 순식간에 해결했다.

  니가 군대에 입대했을때 이전의 "내무실 총기난사"의 덕을 보는것 처럼
우리는 자본주의 살고 있지만 "공산주의", "공산혁명" 의 덕을 보고 있다.

  공산주의가 없었다면 우리가 살고 있는 이곳도 지금의 자본주의가 아니였기 때문이다.(애초 케인즈주의 도입했을때부터 순수 자본주의 거리가 멀다)

아, 그리고 우리나라의 좋은 건강보험도
북한에서 하는 무상의료에 대항하기 위해 만들어졌다.
역시 북한이 없었으면 건강보험도 없거나 약했을 가능성이 크다 / 그 외에도 북한이라는 경쟁자가 있었기에 이승만 정권의 토지개혁도 잘 되었고 부의 분배가 되었다')
