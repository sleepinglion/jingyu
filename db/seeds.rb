...
Blog.create!(id: 24, user_id: 1, blog_category_id: 3,title: '삼인행스승',description: '', created_at: 1.day.ago,tag_list: '',
             content: '
')

Blog.create!(id: 25, user_id: 1, blog_category_id: 3,title: '',description: '', created_at: 1.day.ago,tag_list: '',
             content: '
')
