...
Blog.create!(id: 23, user_id: 1, blog_category_id: 3,title: '나도 배가 참 많아 나왔지만',description: '내 배를 능가하는 아들친구의 배', created_at: 1.day.ago,tag_list: '',
...
권력을 잡으면 자신이 아니면 나라를 이끌 사람이 없다고 생각하게 머리가 이상해진다고 한다.
...
그렇게 지가 헌법을 어겨가며 까지 더 해먹을라고 헌법개정을 하며 3선 출마를 하게 된다.

그러나...!  역시 그래도 대한민국 국민들은 반은 개-돼지 들이였지만 반은 현명한 사람들이였다.
그렇게 부정선거를 했음에도 표차이는 거의 안나게 이겼으니 사실상 진 것이였다.
그렇게 사실상 패배를 당한 저 독재자는 후에 결국 치졸하게 그 경쟁자인 김대중님을 일본에서 암살하려고 했다가 이 치졸하고 역겨운 행태가 만천하에 까발려지게 되는것이다.
...
역시 3선 개헌때 부터 예상되는 일이였지요?
이제 그는 공화국에서 왕으로 부르지는 않는 왕이 되는것이다.
...
하지만 그의 본색은 밤에 여대생들과 먹는 시바스리갈이였으며 정치인들이 다 그러긴 하지만 정말 역겹다고 할 수 있다.
이미 시바스리갈만 처먹다가 맛탱이가 가서 부마항쟁에 대항하여 대학살을 통한 무력진압을 하려고 하였으나 이에 반대하는 김재규의사의 총에 맞고 잘 처리된다.
역사에 만약은 없다지만
그냥 박정희가 5.18이전에 저런 진압을 했으면 지금처럼 개소리 멍멍(박정희 찬양)대는 놈들이 없어서 오히려 좋았을 수도 있을지 모르겠다.

그가 헌법을 지켜 두번까지만 했으면 나는 그를 오히려 지금 개소리 멍멍(박정희 찬양)하는 애들처럼 나도 높게 평가했을 수도 있다.
한번 더 양보해서 그가 3선까지만 하고 은퇴하였으면 그냥 보통 대통령으로 평가했을것이다.
하지만 그는 이미 머리가 이상해져 3선 개헌을 할 때부터 평생 해먹을 생각이였으며 자국민 대학살을 계획했다가 실현하지 못하고 총탄에 맞아 물러나게 된다.

하는짓 모든것이 뭐 저기 아프리카나 남미의 독재자들이 하던 짓과 다를것이 하나 없다.
죽을때 까지 해먹으려다가 부하한테 총맞아 죽는것도 아주 일반적인 독재자의 말로다.
그가 유신개헌하여 더 해먹은 년수는 고작 4~5년..... 참으로 어리석은 인간 욕망의 표상이라고 할 수 있다.
스스로 물러나는 것을 실천하는것을 기대하는것은 무리인가?, 그냥 좀 헌법을 지키라고~~!

하지만 그것을 실천한 지도자도 있다.
그는 바로 미국 건국의 아버지인 조지 워싱턴
그는 오히려 아직 공화정이 익숙하지 않은 국민들이 사실상 왕으로 여기고 그가 평생 통치할줄 알고 있었다.
...
말년에 노욕을 부리고 겨우 4~5년 더 해먹겠다고 하다 총탄 맞아 죽은 역겨운 인간이로다~
')
